...
var __vue_render__ = function() {
  ...
  return _c("div", [
    _c("h1", [_vm._v(_vm._s(_vm.dTitle))]),
    _vm._v(" "),
    _c(
      "ul",
      { attrs: { id: "example-1" } },
...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-540c7f10_0", { source: "\nh1[data-v-540c7f10] {\n  color: rebeccapurple;\n}\n", map: {"version":3,"sources":["/Users/maxime.quentin/devProjects/dd-custom-dashboard-widgets/dd-vuejs-example/src/MyComponent.vue"],"names":[],"mappings":";AA4CA;EACA,oBAAA;AACA","file":"MyComponent.vue","sourcesContent":["<template>\n  <div>\n    <h1>{{ dTitle }}</h1>\n    <ul id=\"example-1\">\n      <li v-for=\"l  in dLogIndex.indexes\" v-bind:key=\"l.scopeId\">\n        {{ l.name }}\n          <ul>\n              <li>\n                 {{ l.query }}\n              </li>\n          </ul>\n      </li>\n  </ul>\n</div>\n</template>\n\n<script>\n    \nexport default {\n  props: {\n    title: {\n      default: \"Title\"\n    },\n    logIndex:{\n      default: {}\n    }\n  },\n  data() {\n    return { \n      dTitle: this.title, \n      dLogIndex: this.logIndex\n      };\n  },\n  mounted () {\n    fetch(`/api/v1/logs/indexes?type=logs`)\n      .then(response => response.json())\n      .then(json => {\n        this.dLogIndex = json;\n    });\n  }\n};\n</script>\n\n<style scoped>\nh1 {\n  color: rebeccapurple;\n}\n</style>\n"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-540c7f10";
  /* module identifier */
